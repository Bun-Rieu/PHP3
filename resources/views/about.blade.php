                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img src="{{ asset('images/avtkhoa.png') }}"
                                    ...
                                    @foreach ($skills as $skill)
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar" role="progressbar"
                                                style="width: {{ rand(50, 100) }}%;" aria-valuenow="85" aria-valuemin="0"
                            ...
                            <div class="col-md-6">
                                <div class="about-me pt-4 pt-md-0">
                                    ...
                                    <p class="lead">
                                        Xin chào! Tôi là {{ $name }}, một {{ $profile }} với niềm đam mê phát
                                        triển web. Tôi có kinh nghiệm với các công nghệ như {{ implode(', ', $skills) }}.
                                    </p>
                                    <p class="lead">
                                        Tôi luôn tìm kiếm cơ hội để nâng cao kỹ năng và mang đến những sản phẩm chất lượng
                                        cao.
                                    </p>
                                    <p class="lead">
                                        Nếu bạn muốn hợp tác, hãy liên hệ với tôi qua email: {{ $email }} hoặc số
                                        điện thoại: {{ $phone }}.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-sm-6 col-md-5">
                                        <div class="about-img">
                                            <img src="{{ asset('images/avthuy.jpg') }}" class="img-fluid rounded b-shadow-a"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-7">
