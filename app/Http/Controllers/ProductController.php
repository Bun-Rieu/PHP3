...
class ProductController extends Controller
{
    ...
    public function show($slug)
    {
        ...
        return view('user.products.show', compact('product', 'variations', 'category', 'brand'));
    }
    ...
    public function indexadmin()
    {
        ...
        return view('admin.product.index', compact('products', 'title', 'totalProducts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.product.edit', compact('product', 'categories', 'title', 'variations', 'brands'));
    }
